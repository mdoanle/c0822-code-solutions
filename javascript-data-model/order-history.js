var orderHistory = [
  ...
  },
  {
    ...
    [
      {
        typeOfItem: 'Hardware',
        nameOfItem: 'GameCube Controller - Super Smash Bros. Edition (Nintendo Switch)',
        itemPrice: 94.95,
        itemImage: 'gamecube-controller.jpg',
        returnWindowCloses: 'September 7, 2020'
      },
      {
        typeOfItem: 'Book',
        nameOfItem: 'The Art of Sql',
        author: 'Faroult, Stephane',
        itemPrice: 33.99,
        itemImage: 'art-sql.jpg',
        returnWindowCloses: 'September 7, 2020'
      }
    ],
